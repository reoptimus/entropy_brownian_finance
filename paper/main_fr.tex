...
\end{equation}
avec $\mathcal{P}$ la mesure aléatoire de Poisson décrivant l'arrivée des
événements informationnels et $z$ l'information mutuelle qu'ils portent. Le
coefficient de diffusion est noté $\sigma_\JJ$ et non $\eta$, cette dernière
lettre étant réservée au rayon des scénarios de stress
(section~\ref{sec:stress}) ; la mesure de saut est notée $\mathcal{P}$ et non
$N$, ce dernier symbole désignant le nombre d'actifs. Lu sur l'entropie elle-même plutôt que sur
